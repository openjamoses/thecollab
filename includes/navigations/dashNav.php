...
<div class="subnavbar">
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"><a href="index?!=dashboard|<?php echo $_SESSION['staff_no'] ?>ii83837929n22n2b2782ey27ey2hj228hjshhwhw"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
                ...
                <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-tags"></i><span>Enrollment</span> <b class="caret"></b></a>
                 ...
                 <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-copy"></i><span>Mark sheet</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <?php
                        $sqlQuery = "SELECT * FROM class_tb";
