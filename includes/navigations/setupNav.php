        ...
        <div class="container">
            <ul class="mainnav">
                ...
                <?php } ?>
                 ...
                 <li class="dropdown active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Setups</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
