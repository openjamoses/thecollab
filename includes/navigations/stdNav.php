    ...
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                ...
                <li class="dropdown active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i><span> <?php echo $student; ?>s</span> <b class="caret"></b></a>
