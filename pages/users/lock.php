...
<head>
  ...
  <!-- Favicons -->
  <link href="advanced/images/favicon.ico"  rel="icon">
  <link href="advanced/images/favicon.ico" rel="icon" type="image/x-icon"/>
...
<body onload="getTime()">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="centered"><img class="img-circle" width="80" src="dashio/img/ui-sam.jpg"></p>
  ...
  <script>
    $.backstretch("dashio/img/lock.jpeg", {
      speed: 500
    });
  </script>
  <script>
