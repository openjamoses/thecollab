                ...
                <div class="container">
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="index?!=dashboard|uewyiywuiynnncvbdyusdin jhsuisiuwiuwe9287217725265363">
                ...
                <div class="row">
                    ...
                    if (Input::exists() && Input::get("submitDetails")) {
                        ...
                        if (DB::getInstance()->checkRows($queryDup1)) {
                            $users_list = DB::getInstance()->query($queryDup1);
                            foreach ($users_list->results() as $users):
                                $institution_name = DB::getInstance()->getName("institution_tb", $institution, "institution_name", "institution_id");
                                echo '<div class="alert alert-warning">Please contact the Lead collaboration for <a href=""> ' . $institution_name . '</a>, <a href="">' . $users->users_designation . ' ' . $users->users_name . '</a> on <a href="">' . $users->users_email . '</a> to add you to there platform..! </div>';
