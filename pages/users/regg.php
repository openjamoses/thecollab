            ...
            <div class="body-nav body-nav-vertical body-nav-fixed">
                <div class="container">
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <i class="icon-calendar icon-large"></i> Research Institution
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="icon-map-marker icon-large"></i> Server Instances
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="icon-tasks icon-large"></i> Contributers
                            </a>
                        </li>
                        <li>
                            <a href="#">
