                    ...
                    <div class="span8">
                        <div class="box">
                            ...
                            if (Input::exists() && Input::get("addCollaboration")) {
                                ...
                                $queryDup = "SELECT * FROM contribution_tb WHERE contribution_title='$title'";
                                if (DB::getInstance()->checkRows($queryDup)) {
                                    echo '<div class="alert alert-warning">The Study title is already taken..!</div>';
                                } else {
                                    $insertQuery = DB::getInstance()->insert("contribution_tb", array(
                                        'contribution_title' => $title,
                                        'contribution_details' => $descriptions,
                                        'contribution_date' => $date_today,
                                        'contribution_time' => $current_time,
                                        'study_type_id' => $study_title,
                                        'user' => $_SESSION['id']
                                    ));
                                    if ($insertQuery) {
                                        ...
                                        $event_body = "Created new collaboration";
                            ...
                            <form action="#" method="POST" class="form-inline">
                                ...
                                <div class="box-content">
                                    ...
                                    ?> class="chosen span6" name="study_title" data-placeholder="Choose Study Category..." required="">
                                        <option value=""></option>
                                        <?php
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        ?>rows="2" class="span5" name="title" placeholder="Enter the study title"><?php
                                            if ($id != 0) {
                                                echo $title;
                                            }
                                            ?></textarea>
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        ?> class="span5" name="descriptions" rows="10"  placeholder="Enter the Study Details"><?php
                                            if ($id != 0) {
                                                echo $desc;
                                            }
                                            ?></textarea>
...
<?php if ($id == 0) { ?>
                                        ...
                                        $user_id = DB::getInstance()->getName("contribution_tb", $id, "user", "contribution_id");
                                        if ($user_id == $_SESSION['id']) {
                                            ?>
                                            <div class="box-footer">
                                                <a href="index?!=invites_collab&%=<?php echo $id; ?>|<?php echo $user_id; ?>|uewyiywuiynnncvbdyusdin jhsuisiuwiuwe9287217725265363" class="btn btn-info"> <i class="icon-hand-up"></i> Invite collaborator</a>
                                            </div>
                                            <?php
                                        }
                                    }
